...
// of the class CGaussJacobiQuadrature.
//------------------------------------------------------------------------------

// Include files needed.
#include "VCP3D_CurviLinear.hpp"

void CGaussJacobiQuadrature::GetQuadraturePoints(
                             ...
                             std::vector<double> &GJPoints, std::vector<double> &GJWeights)
{
  ...
  if(nIntPoints < 1 || nIntPoints > 100)
    Terminate("CGaussJacobiQuadrature::GetQuadraturePoints", __FILE__, __LINE__,
              "Invalid number of Gauss Jacobi integration points");
...
void CGaussJacobiQuadrature::cdgqf(int nt, int kind, double alpha, double beta,
                                   double t[], double wts[])
...
void CGaussJacobiQuadrature::cgqf(int nt, int kind, double alpha, double beta,
...
double CGaussJacobiQuadrature::class_matrix(int kind, int m, double alpha,
                                               double beta, double aj[], 
                                               double bj[])
...
void CGaussJacobiQuadrature::imtqlx(int n, double d[], double e[], double z[])
...
void CGaussJacobiQuadrature::parchk(int kind, int m, double alpha, double beta)
...
double CGaussJacobiQuadrature::r8_epsilon( )
...
double CGaussJacobiQuadrature::r8_sign(double x)
...
void CGaussJacobiQuadrature::scqf(int nt, double t[], int mlt[], double wts[],
                                  int nwts, int ndx[], double swts[], double st[],
                                  int kind, double alpha, double beta, double a, 
                                  double b)
...
void CGaussJacobiQuadrature::sgqf(int nt, double aj[], double bj[],

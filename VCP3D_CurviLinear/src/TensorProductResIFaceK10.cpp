//------------------------------------------------------------------------------
// TensorProductResIFaceK10.cpp: Implementation of the functions that carries out
                              ...
                              su2double **C)
{
  ...
  switch( M )
  {
    case 14: TPRIF<10,14>(N,AFacex,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResIFace", 10, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResIFaceK2.cpp: Implementation of the functions that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 2: TPRIF<2,2>(N,AFacex,ATy,ATz,B,C); break;
    case 3: TPRIF<2,3>(N,AFacex,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResIFace", 2, M);
  }
}

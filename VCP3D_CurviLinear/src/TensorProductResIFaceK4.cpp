//------------------------------------------------------------------------------
// TensorProductResIFaceK4.cpp: Implementation of the functions that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 5: TPRIF<4,5>(N,AFacex,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResIFace", 4, M);
  }
}

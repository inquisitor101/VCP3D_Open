//------------------------------------------------------------------------------
// TensorProductResIFaceK5.cpp: Implementation of the functions that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  7: TPRIF<5, 7>(N,AFacex,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResIFace", 5, M);
  }
}

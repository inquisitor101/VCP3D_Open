//------------------------------------------------------------------------------
// TensorProductResIFaceK7.cpp: Implementation of the functions that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  9: TPRIF<7, 9>(N,AFacex,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResIFace", 7, M);
  }
}

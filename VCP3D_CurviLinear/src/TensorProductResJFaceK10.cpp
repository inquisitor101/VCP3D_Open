//------------------------------------------------------------------------------
// TensorProductResJFaceK10.cpp: Implementation of the function that carries out
                              ...
                              su2double **C)
{
  ...
  switch( M )
  {
    case 14: TPRJF<10,14>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 10, M);
  }
}

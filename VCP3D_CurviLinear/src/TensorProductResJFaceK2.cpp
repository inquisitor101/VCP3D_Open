//------------------------------------------------------------------------------
// TensorProductResJFaceK2.cpp: Implementation of the function that carries out
//                              the tensor product multiplications to compute
//                              the contribution from a J face to the residual.
//------------------------------------------------------------------------------

// Include files needed.
#include "VCP3D_CurviLinear.hpp"
#include "TensorProductResJFace.hpp"
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 2: TPRJF<2,2>(N,ATx,AFacey,ATz,B,C); break;
    case 3: TPRJF<2,3>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 2, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResJFaceK3.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 4: TPRJF<3,4>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 3, M);
  }
}

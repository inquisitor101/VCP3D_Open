//------------------------------------------------------------------------------
// TensorProductResJFaceK4.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 5: TPRJF<4,5>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 4, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResJFaceK5.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  7: TPRJF<5, 7>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 5, M);
  }
}

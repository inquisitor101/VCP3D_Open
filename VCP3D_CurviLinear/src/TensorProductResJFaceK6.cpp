//------------------------------------------------------------------------------
// TensorProductResJFaceK6.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  8: TPRJF<6, 8>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 6, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResJFaceK7.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  9: TPRJF<7, 9>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 7, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResJFaceK9.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 13: TPRJF<9,13>(N,ATx,AFacey,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductResJFace", 9, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResKFaceK10.cpp: Implementation of the function that carries out
                              ...
                              su2double **C)
{
  ...
  switch( M )
  {
    case 14: TPRKF<10,14>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 10, M);
  }
}

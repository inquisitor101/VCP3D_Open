//------------------------------------------------------------------------------
// TensorProductResKFaceK2.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 2: TPRKF<2,2>(N,ATx,ATy,AFacez,B,C); break;
    case 3: TPRKF<2,3>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 2, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResKFaceK3.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 4: TPRKF<3,4>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 3, M);
  }
}

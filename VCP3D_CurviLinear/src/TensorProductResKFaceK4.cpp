//------------------------------------------------------------------------------
// TensorProductResKFaceK4.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 5: TPRKF<4,5>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 4, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResKFaceK5.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  7: TPRKF<5, 7>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 5, M);
  }
}

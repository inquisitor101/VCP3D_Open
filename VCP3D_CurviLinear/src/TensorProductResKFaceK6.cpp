//------------------------------------------------------------------------------
// TensorProductResKFaceK6.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case  8: TPRKF<6, 8>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 6, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductResKFaceK8.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 12: TPRKF<8,12>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 8, M);
  }
}

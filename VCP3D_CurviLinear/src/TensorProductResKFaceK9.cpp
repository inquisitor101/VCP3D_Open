//------------------------------------------------------------------------------
// TensorProductResKFaceK9.cpp: Implementation of the function that carries out
                             ...
                             su2double **C)
{
  ...
  switch( M )
  {
    case 13: TPRKF<9,13>(N,ATx,ATy,AFacez,B,C); break;
    default: TerminateTensorProduct("TensorProductResKFace", 9, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK10.cpp: Implementation of the function that carries
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 14: TPSAGI<10,14>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 10, M);
  }
}

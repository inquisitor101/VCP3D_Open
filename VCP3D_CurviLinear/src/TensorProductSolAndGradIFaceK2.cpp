//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK2.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 2: TPSAGI<2,2>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 3: TPSAGI<2,3>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 4: TPSAGI<2,4>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 5: TPSAGI<2,5>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 2, M);
  }
}

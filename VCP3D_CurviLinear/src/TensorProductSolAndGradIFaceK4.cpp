//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK4.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 5: TPSAGI<4,5>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 4, M);
  }
}

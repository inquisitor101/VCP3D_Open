//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK6.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  8: TPSAGI<6, 8>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 6, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK7.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  9: TPSAGI<7, 9>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 7, M);
  }
}

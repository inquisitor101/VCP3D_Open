//------------------------------------------------------------------------------
// TensorProductSolAndGradIFaceK9.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 13: TPSAGI<9,13>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradIFace", 9, M);
  }
}

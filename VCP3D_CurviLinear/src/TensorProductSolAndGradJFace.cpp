//------------------------------------------------------------------------------
// TensorProductSolAndGradJFace.cpp: Implementation of the functions that carry
                                  ...
                                  su2double **CDerZ)
{
  ...
  switch( K )
  {
    case  2: TensorProductSolAndGradJFaceK2(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  3: TensorProductSolAndGradJFaceK3(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  4: TensorProductSolAndGradJFaceK4(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  5: TensorProductSolAndGradJFaceK5(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  6: TensorProductSolAndGradJFaceK6(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  7: TensorProductSolAndGradJFaceK7(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  8: TensorProductSolAndGradJFaceK8(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case  9: TensorProductSolAndGradJFaceK9(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 10: TensorProductSolAndGradJFaceK10(M,N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default:
      TerminateAll("TensorProductSolAndGradJFace", __FILE__, __LINE__,

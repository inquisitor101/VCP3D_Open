//------------------------------------------------------------------------------
// TensorProductSolAndGradJFaceK10.cpp: Implementation of the function that carries
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 14: TPSAGJ<10,14>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradJFace", 10, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradJFaceK2.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 2: TPSAGJ<2,2>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 3: TPSAGJ<2,3>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 4: TPSAGJ<2,4>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 5: TPSAGJ<2,5>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradJFace", 2, M);
  }
}

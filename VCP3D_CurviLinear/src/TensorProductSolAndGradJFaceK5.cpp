//------------------------------------------------------------------------------
// TensorProductSolAndGradJFaceK5.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  7: TPSAGJ<5, 7>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradJFace", 5, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradJFaceK6.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  8: TPSAGJ<6, 8>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradJFace", 6, M);
  }
}

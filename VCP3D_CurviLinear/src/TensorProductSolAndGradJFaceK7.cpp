//------------------------------------------------------------------------------
// TensorProductSolAndGradJFaceK7.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  9: TPSAGJ<7, 9>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradJFace", 7, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK10.cpp: Implementation of the function that carries
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 14: TPSAGK<10,14>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 10, M);
  }
}

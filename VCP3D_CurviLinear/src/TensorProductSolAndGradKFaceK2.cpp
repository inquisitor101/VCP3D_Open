//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK2.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 2: TPSAGK<2,2>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 3: TPSAGK<2,3>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 4: TPSAGK<2,4>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    case 5: TPSAGK<2,5>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 2, M);
  }
}

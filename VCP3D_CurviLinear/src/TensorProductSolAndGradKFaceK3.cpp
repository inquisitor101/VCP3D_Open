//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK3.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 4: TPSAGK<3,4>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 3, M);
  }
}

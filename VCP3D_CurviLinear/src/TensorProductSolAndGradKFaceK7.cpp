//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK7.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  9: TPSAGK<7, 9>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 7, M);
  }
}

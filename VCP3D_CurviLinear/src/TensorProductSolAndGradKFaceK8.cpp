//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK8.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 12: TPSAGK<8,12>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 8, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradKFaceK9.cpp: Implementation of the function that carries
                                    ...
                                    su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 13: TPSAGK<9,13>(N,A,ADer,AFace,ADerFace,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradKFace", 9, M);
  }
}

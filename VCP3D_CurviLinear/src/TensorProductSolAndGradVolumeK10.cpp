//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK10.cpp: Implementation of the function that
                                      ...
                                      su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 10: TPSAGV<10,10>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 14: TPSAGV<10,14>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK10", 10, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK2.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 2: TPSAGV<2,2>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 3: TPSAGV<2,3>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 4: TPSAGV<2,4>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 5: TPSAGV<2,5>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK2", 2, M);
  }
}

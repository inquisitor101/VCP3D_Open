//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK3.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 3: TPSAGV<3,3>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 4: TPSAGV<3,4>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK3", 3, M);
  }
}

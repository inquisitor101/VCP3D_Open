//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK4.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case 4: TPSAGV<4,4>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 5: TPSAGV<4,5>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 6: TPSAGV<4,6>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 7: TPSAGV<4,7>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case 8: TPSAGV<4,8>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK4", 4, M);
  }
}

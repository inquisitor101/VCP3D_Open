//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK5.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  5: TPSAGV<5, 5>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case  7: TPSAGV<5, 7>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK5", 5, M);
  }
}

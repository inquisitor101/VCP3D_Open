//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK6.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  6: TPSAGV<6, 6>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case  8: TPSAGV<6, 8>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK6", 6, M);
  }
}

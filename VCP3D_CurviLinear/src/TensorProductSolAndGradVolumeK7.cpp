//------------------------------------------------------------------------------
// TensorProductSolAndGradVolumeK7.cpp: Implementation of the function that
                                     ...
                                     su2double **CDerZ)
{
  ...
  switch( M )
  {
    case  7: TPSAGV<7, 7>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    case  9: TPSAGV<7, 9>(N,A,ADer,B,C,CDerX,CDerY,CDerZ); break;
    default: TerminateTensorProduct("TensorProductSolAndGradVolumeK7", 7, M);
  }
}

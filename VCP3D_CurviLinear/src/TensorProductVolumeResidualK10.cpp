//------------------------------------------------------------------------------
// TensorProductVolumeResidualK10.cpp: Implementation of the functions that carries
                                    ...
                                    su2double **C)
{
  ...
  switch( M )
  {
    case 14: TPAVR<10,14>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 10, M);
  }
}

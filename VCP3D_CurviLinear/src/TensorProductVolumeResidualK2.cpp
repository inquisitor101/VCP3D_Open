//------------------------------------------------------------------------------
// TensorProductVolumeResidualK2.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case 2: TPAVR<2,2>(N,ATx,ATy,ATz,B,C); break;
    case 3: TPAVR<2,3>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 2, M);
  }
}

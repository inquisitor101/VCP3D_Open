//------------------------------------------------------------------------------
// TensorProductVolumeResidualK3.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case 4: TPAVR<3,4>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 3, M);
  }
}

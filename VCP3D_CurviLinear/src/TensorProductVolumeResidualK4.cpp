//------------------------------------------------------------------------------
// TensorProductVolumeResidualK4.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case 5: TPAVR<4,5>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 4, M);
  }
}

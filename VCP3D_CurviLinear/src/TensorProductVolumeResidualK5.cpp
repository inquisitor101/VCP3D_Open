//------------------------------------------------------------------------------
// TensorProductVolumeResidualK5.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case  7: TPAVR<5, 7>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 5, M);
  }
}

//------------------------------------------------------------------------------
// TensorProductVolumeResidualK7.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case  9: TPAVR<7, 9>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 7, M);
  }
}

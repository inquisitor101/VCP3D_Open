//------------------------------------------------------------------------------
// TensorProductVolumeResidualK8.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case 12: TPAVR<8,12>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 8, M);
  }
}

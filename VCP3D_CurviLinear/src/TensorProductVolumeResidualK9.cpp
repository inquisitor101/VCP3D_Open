//------------------------------------------------------------------------------
// TensorProductVolumeResidualK9.cpp: Implementation of the functions that carries
                                   ...
                                   su2double **C)
{
  ...
  switch( M )
  {
    case 13: TPAVR<9,13>(N,ATx,ATy,ATz,B,C); break;
    default: TerminateTensorProduct("TensorProductVolumeResidual", 9, M);
  }
}
